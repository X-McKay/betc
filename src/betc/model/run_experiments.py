...
#         base_model_names=["distilbert-base-uncased", "roberta-base", "bert-base-uncased"],
#         param_grid={
...
#     Args:
#         base_model_name (str): Name of the BERT variant to use
...
#         logger.error(f"Error in experiment with {base_model_name}: {e!s}")
#         return {"error": str(e)}
...
#             for param_config in tqdm(param_configs, desc=f"Running {base_model_name} experiments"):
#                 # Run experiment
...
#     logger.info(f"Best model: {best_results['base_model_name']}")
...
from betc.model.config import (
    ServicesConfig, MLflowConfig, TensorBoardConfig, ServiceMode
)
...
# Run with custom model variants and parameter grid
